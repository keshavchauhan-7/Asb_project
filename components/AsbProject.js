        ...
        <ImageBackground source={{ uri: 'https://i.pinimg.com/564x/c0/04/e8/c004e81754823d7191f1d2d354be68ee.jpg' }} style={{ width: '100%', height: '100%' }}>
            <View style={styles.container}>
                ...
                <View style={styles.containerTwo}>
                    ...
                    <Text style={{ fontSize: 18, marginTop: 20, textAlign: 'center', color:'gray' }}>Sign up with</Text>
                    ...
                    <View style={{ width: '100%', marginTop: 20 }}>
                        ...
                        <View style={styles.inputContainer}>
                            <View style={styles.input}>
                                ...
                                <Text style={{ fontSize: 20, color:'gray' }}>Email</Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.inputContainer}>
                            <View style={styles.input}>
                                ...
                                <Text style={{ fontSize: 20, color:'gray' }}>Password</Text>
                            </View>
                        </View>
